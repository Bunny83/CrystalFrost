...
namespace OpenMetaverse.TestClient_.Commands.Movement
{
    class FlyToCommand : Command
    {
        ...
        {
            Jenny.Console.WriteLine(String.Format(x + " {0,3:##0} {1,3:##0} {2,3:##0} diff {3,5:##0.0} olddiff {4,5:##0.0}  At:{5,5} {6,5}  Up:{7,5} {8,5}  v: {9} w: {10}",
